...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    // const ROLE_USER = 10;
    // const ROLE_ADMIN = 11;
    // const ROLE_ASSISTANTLIBRARIAN = 12;
    ...
    {
		$memberRoleId = Yii::$app->db->createCommand("select id from role where rolename='member'")->queryScalar();    	
        return [
            ['active', 'default', 'value' => self::STATUS_ACTIVE],
            ['active', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_INACTIVE]],

            ['role', 'default', 'value' => $memberRoleId],
        ];
    }
